...
% Check if files exist else use other fonts

\IfFileExists{metaoffice-fonts/MetaOffcPro-Bold.ttf}{
\IfFileExists{metaoffice-fonts/MetaOffcPro-Norm.ttf}{
\IfFileExists{metaoffice-fonts/MetaOffcPro-NormIta.ttf}{
\IfFileExists{metaoffice-fonts/MetaScOffcPro-Bold.ttf}{
\IfFileExists{metaoffice-fonts/MetaScOffcPro-Norm.ttf}{
\IfFileExists{metaoffice-fonts/MetaScOffcPro-NormIta.ttf}{
\setmainfont{MetaOffcPro}[Path=metaoffice-fonts/,
Extension=.ttf,
UprightFont=*-Norm,
UprightFeatures={
...
\setsansfont{MetaOffcPro}[Path=metaoffice-fonts/,
Extension=.ttf,
UprightFont=*-Norm,
UprightFeatures={
	SmallCapsFont={MetaScOffcPro-Norm}
